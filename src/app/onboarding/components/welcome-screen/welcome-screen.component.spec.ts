...
describe('WelcomeScreenComponent #onboarding', () => {
	...
	beforeEach(() => {
		return MockBuilder(WelcomeScreenComponent, DummyModule);
	});

	it('should exist', async () => {
		const fixture = await defaultRender();
	...
	it('should pass up a selected archive', async () => {
		...
		const selectInvitationSpy = spyOn(fixture.point.componentInstance.selectInvitation, 'emit');
