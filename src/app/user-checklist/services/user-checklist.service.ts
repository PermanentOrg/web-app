...
// The checklist is only shown to accounts with Owner access to their own
// default archive, so the "Create your first archive" step is always complete
// for anyone who can see it. Mark it as complete regardless of what the API
// reports.
