...
describe('NewArchiveFormComponent #onboarding', () => {
	let fixture: ComponentFixture<NewArchiveFormComponent>;
	let instance: NewArchiveFormComponent;

	function fillOutForm() {
		const input = ngMocks.find('#newArchiveName');
		ngMocks.change(input, 'Test User');
		const radio = ngMocks.find('input[type="radio"][required]');
	...
	beforeEach(() =>
		MockBuilder(NewArchiveFormComponent, SharedModule)
			.keep(FormsModule)
