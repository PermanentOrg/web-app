...
export const SHARE_EVENTS: NestedEventDict = {
  ShareByRelationship: {
    initiated: {
      ...
      params: {
        hitType: 'event',
        eventCategory: 'Share by relationship',
  ...
  ShareByAccountNoRel: {
    initiated: {
      ...
      params: {
        hitType: 'event',
        eventCategory: 'Share by account no rel',
        eventAction: 'initiated',
      },
    },
    previewed: {
