...
describe('ProfileService', () => {
	beforeEach(() =>
		MockBuilder(ProfileService)
			.mock(MessageService, { showError: () => {} })
			.provide({ provide: ApiService, useValue: mockApiService })
			.provide({ provide: PrConstantsService, useValue: mockConstantsService })
			.provide({ provide: AccountService, useValue: mockAccountService })
			.provide({ provide: FolderPickerService, useValue: mockFolderPickerService }),
	);
