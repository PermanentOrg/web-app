export const TOOLTIPS = {
  fileList: {
    actions: {
      ...
      newFolder: {
        ...
        disabled:
          'You do not have permission to create a folder in the current folder',
      },
      download: {
  ...
  members: {
    ...
    contributor:
      'A member with permission to view and create files and folders (e.g. upload only)',
    editor: 'A member with permission to view, create, and edit metadata',
    curator:
      'A member with permission to view, create, edit, move, copy, and delete files and folders',
    manager:
      'A member with all file and folder permissions and the permission to modify membership',
    owner:
      'a member with all permissions including transferring ownership or deleting the archive',
  },
};
