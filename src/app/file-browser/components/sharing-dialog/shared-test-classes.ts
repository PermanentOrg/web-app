...
export class MockShareLinkMappingService {
	...
	public accessRoleToPermissionsLevel = (accessRole: string) => {
		if (accessRole === 'access.role.owner') {
			return 'owner';
		}
		if (accessRole === 'access.role.editor') {
			return 'editor';
		}
		return 'viewer';
	};

	public permissionsLevelToAccessRole = (permissionsLevel: string) => {
		if (permissionsLevel === 'owner') {
			return 'access.role.owner';
		}
		if (permissionsLevel === 'editor') {
